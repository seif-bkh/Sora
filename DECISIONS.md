...
| 75 | **UNVERIFIED locally: no Kotlin in this phase has been compiled.** | The sandbox has no JDK or Android SDK and every Maven/Google host is unreachable. CI is the first compiler to see this code, exactly as in Phases 1a/1b. |
